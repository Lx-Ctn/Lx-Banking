...
export const BankDropdown = ({ accounts = [], setValue, otherStyles }: BankDropdownProps) => {
	...
	useEffect(() => {
		if (setValue) setValue("senderBank", accounts[0].appwriteItemId);
	}, [setValue, accounts]);
	...
	return (
		<Select value={selected.appwriteItemId} onValueChange={value => handleBankChange(value)}>
			...
			<SelectContent className={`w-full md:w-[300px] ${otherStyles}`} align="end">
				<SelectGroup>
